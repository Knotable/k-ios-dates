...
@property (nonatomic, assign) UIViewContentMode orignContentMode;
...
//    [app setStatusBarHidden:YES withAnimation:UIStatusBarAnimationFade];
    ...
    self.orignContentMode = self.liftedImageView.contentMode;
...
- (void) animationDidStop:(CAAnimation *)anim finished:(BOOL)flag {
    if ([[anim valueForKey:@"type"] isEqual:@"contract"]) {
        ...
        self.imageView.contentMode = self.orignContentMode;
