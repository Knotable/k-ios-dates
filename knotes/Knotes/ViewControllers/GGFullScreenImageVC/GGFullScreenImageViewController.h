...
@property (nonatomic, assign) UIViewContentMode contentMode; //default is UIViewContentModeScaleAspectFit
@property (nonatomic, copy) void(^eventToUnHideStack)(BOOL value);
