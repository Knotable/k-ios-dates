...
@implementation SharePeopleCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        _lbDescription.font = kCustomLightFont(10);
...
- (void)updateConstraints
{
    ...
    [_imgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.shadeView).with.offset(      10.0);
    }];
    
    [_lbTitle mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.shadeView).with.offset(       8.0);
        make.bottom.equalTo(self.shadeView).with.offset(    -8.0);
        make.left.equalTo(self.shadeView).with.offset(      52.0);
