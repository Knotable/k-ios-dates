...
#import "MCSWLongPressGestureRecognizer.h"
...
//static CGFloat const kMCStop2                       = 0.67; // Percentage limit to trigger the second action
static CGFloat const kMCStop2                       = 0.33; // Percentage limit to trigger the second action
...
@interface MCSwipeTableViewCell () <UIGestureRecognizerDelegate, UIScrollViewDelegate>
