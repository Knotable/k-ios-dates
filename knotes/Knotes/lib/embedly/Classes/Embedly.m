...
// AFNetworking_2_And_Above_Installed
// Will help us collaborate (those who have AFNetworking 1.* and 2.*
// We should probably keep track of AFNetworking as a pod, and have same version all.

    // Moved this outside of the "if" because it's needed in both cases.
    NSString *baseUrl = @"http://api.embed.ly";
    NSString *path = [embedlyUrl stringByReplacingOccurrencesOfString:baseUrl withString:@""];
    
#if AFNetworking_2_And_Above_Installed//todo pod update
...
//    [requestSerializer setValue:@"embedly-ios/1.0" forHTTPHeaderField:@"User-Agent"];
    ...
    [client setDefaultHeader:@"embedly-ios/1.0" value:@"User-Agent"];
