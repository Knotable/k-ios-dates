...
//        self.layer.borderWidth = 1.0f;
        ...
        highlight.backgroundColor = [UIColor redColor];
        highlight.layer.cornerRadius = 6.0f;
        [self addSubview:highlight];
        self.highlight = highlight;
        self.bgView = [[UIImageView alloc] initWithImage:[CUtil imageWithName:@"text-field-bg" type:ImageStretchable]];
        self.bgView.autoresizesSubviews = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
        ...
        [prevButton setImage:[UIImage imageNamed:@"arrow-left"] forState:UIControlStateNormal];
...
//        calendarContainer.clipsToBounds = YES;
        ...
        UIImageView *daysHeader = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"days-background"]];
...
- (void)layoutSubviews {
    ...
    newFrame.size.height = 6*(self.cellHeight + CELL_BORDER_WIDTH) + DAYS_HEADER_HEIGHT + CALENDAR_MARGIN + TOP_HEIGHT;
    self.frame = newFrame;
    ...
    while ([self dateIsInMonthShowing:date]) {
        ...
        if ([self isSameDay:dateButton.date date2:self.selectedDate]) {
...
- (void)setDefaultStyle {
    ...
    [self setTitleFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:17.0]/*[UIFont boldSystemFontOfSize:17.0]*/];

    [self setDayOfWeekFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:12.0]/*[UIFont boldSystemFontOfSize:12.0]*/];
    ...
    [self setDateFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:16.0]/*[UIFont boldSystemFontOfSize:16.0f]*/];
...
- (void)setButtonColor:(UIColor *)color {
    [self.prevButton setImage:[LCCalendarView imageNamed:@"arrow-left" withColor:color] forState:UIControlStateNormal];
    [self.nextButton setImage:[LCCalendarView imageNamed:@"arrow-right" withColor:color] forState:UIControlStateNormal];
}
