...
#define TEXT_LABEL_FONT [UIFont fontWithName:@"HelveticaNeue-Light" size:12.0]
...
- (void)setStatusBarStyle:(UIStatusBarStyle)statusBarStyle
{
        ...
        IS_IPAD)
    {
        ...
        [self setBackgroundColor:[UIColor colorWithWhite:0.941 alpha:1.000]/*[DesignManager knoteNavigationBarTintColor]*/];
        
//        [self setBackgroundColor:[UIColor orangeColor]];
        
        self.textLabel.textColor = [UIColor blackColor];
        /*******Dhruv: I have Changed Top progress view color also uncommet it if it is not required.******/
        //[self setProgressBackgroundColor:[UIColor colorWithRed:48/255.0f green:159/255.0f blue:211/255.0f alpha:1]];
        [self setProgressBackgroundColor:[UIColor colorWithWhite:0.941 alpha:1.000]];
...
//        [self setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"status-bar-pattern-default.jpg"]]];
        ...
        [self setBackgroundColor:[UIColor colorWithWhite:0.941 alpha:1.000]/*[UIColor orangeColor]*/];
