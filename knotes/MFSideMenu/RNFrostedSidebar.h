...
@property (nonatomic, strong, readonly) SideMenuViewController *contentView;
...
- (instancetype)initWithsideImages:(NSArray *)images selectedIndices:(NSIndexSet *)selectedIndices borderColors:(NSArray *)colors;
