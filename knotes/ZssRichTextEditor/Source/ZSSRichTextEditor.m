...
//  self.sourceView.autocorrectionType = UITextAutocorrectionTypeNo;
    self.sourceView.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:13.0];
...
- (void)focusTextEditor {
    self.editorView.keyboardDisplayRequiresUserAction = NO;
    [self.editorView stringByEvaluatingJavaScriptFromString: @"document.body.style.fontFamily = 'Arial'"];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    [webView stringByEvaluatingJavaScriptFromString: @"document.body.style.fontFamily = 'Arial'"];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
   ...
   // self.editorView.opaque = NO;
    //self.editorView.backgroundColor = [UIColor yellowColor];
}
...
- (void)keyboardWillShowOrHide:(NSNotification *)notification {
    ...
    if ([notification.name isEqualToString:UIKeyboardWillShowNotification]) {
        ...
        [UIView animateWithDuration:duration delay:0.1 options:animationOptions animations:^{
...
//            editorFrame.size.height = (self.view.frame.size.height - keyboardHeight) - extraHeight;
            
            editorFrame.size.height = self.view.frame.size.height - 20;
...
//            sourceFrame.size.height = (self.view.frame.size.height - keyboardHeight) - sizeOfToolbar - extraHeight;
            sourceFrame.size.height = (self.view.frame.size.height - keyboardHeight) - extraHeight;
