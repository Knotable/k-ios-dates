...
zss_editor.init = function() {
    //$('#zss_editor_content').text("hmmmmm mmmmm mmmmm mmm");
    //$('#zss_editor_content').css('font-family','Helvetica Neue');
...
zss_editor.focusEditor = function() {
    ...
    editor.focus();
//    $('#zss_editor_content').text("hmmmmm mmmmm mmmmm mmm");
//    $('#zss_editor_content').css('font-family','Arial');
//    $('#zss_editor_content').css('font-size','12px');
//font-size: 16px;
